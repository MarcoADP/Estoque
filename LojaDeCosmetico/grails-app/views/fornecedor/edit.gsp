...
<html>
	...
	<body>
		%{--<a href="#edit-fornecedor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-fornecedor" role="main">
			...
			<div class="row col-lg-6">
				<g:form url="[resource:fornecedorInstance, action:'update']" method="PUT"  class="form-horizontal">
