...
<html>
	...
	<body>
		%{--<a href="#create-itemCompra" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="create-itemCompra" role="main">
			...
			<g:form url="[resource:itemCompraInstance, action:'save']"  class="form-horizontal">
