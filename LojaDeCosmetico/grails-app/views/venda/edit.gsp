...
<html>
	...
	<body>
		%{--<a href="#edit-venda" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		<div id="edit-venda" role="main">
			...
			<g:form url="[resource:vendaInstance, action:'update']" method="PUT"  class="form-horizontal">
